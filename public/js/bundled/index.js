...
},{"./leaflet":"xvuTT","./login":"7yHem","./stripe":"10tSC"}],"xvuTT":[function(require,module,exports) {
...
const useFetch = async (url, uploadData = null, method = null)=>{
    try {
        const req = uploadData ? fetch(url, {
        ...
        if (err.message === "Failed to fetch") err.message = `Unable to reach the server. Please check your internet connection...`;
        throw err;
    }
};
...
const updatePassword = async (data)=>{
    try {
        const res = await useFetch("http://localhost:3000/api/v1/users/updateMyPassword", data, "PATCH");
        if (res.status !== "success") return;
        (0, _alerts.showAlert)("success", "Data updated successfully");
    } catch (err) {
        (0, _alerts.showAlert)("error", err.message);
...
var _alerts = require("./alerts");
const stripe = Stripe("pk_test_51Mbmt0HQd2MuRgytHSEZBZBBXff8Kh9K4vPiXIZSqySt38atNcTnmXYT2NK5jJotwRqTrGt0cFF7nrKsXg8horma00ADNknIKo");
...
var Buffer = require("194713c2977b0a36").Buffer;
"use strict";
/**
...
},{"194713c2977b0a36":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("4233d14f7e02d10f");
var ieee754 = require("94fa07c40a184fc5");
...
},{"4233d14f7e02d10f":"eIiSV","94fa07c40a184fc5":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
